      ...
      <div className="min-h-[70vh] flex flex-col justify-center">
        ...
        <div className="mb-8">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight flex items-center gap-3">
            <span className="bg-gradient-to-r from-green-400 via-green-400/90 to-green-400/80 bg-clip-text text-transparent">
              &lt;
            </span>

            <span>Khi Kidman</span>

            <span className="bg-gradient-to-r from-green-400/80 via-green-400/70 to-green-400/60 bg-clip-text text-transparent">
              /&gt;
            </span>
          </h1>

          <div className="mt-4 h-[3px] w-180 bg-gradient-to-r from-green-400/80 to-transparent" />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-8">
          ...
          <a
            ...
            className="
              px-6 py-3
              bg-green-400
              shadow-[0_0_13px_rgba(59,246,130,0.6)]
              text-black
              font-semibold
              rounded-full
              hover:bg-green-300
          ...
          <div className="flex gap-5">
            ...
            <a
              ...
              className="
                ...
                hover:shadow-[0_0_15px_rgba(74,222,128,0.4)]
